...
# TODO Mover constantes de configuración a archivo settings o config
# TODO Mover estilos a styles
WIN_HEIGHT:int = 1000
WIN_WIDTH:int = 1200
...
CONFIG_FILE = toml.load('pyproject.toml')
APP_VERSION = CONFIG_FILE['tool']['poetry']['version']
...
async def main(page: ft.Page):
    ...
    page.title = f"BBQ Balance v{APP_VERSION}"
